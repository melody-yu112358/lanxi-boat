...
本项目可授权的程序代码采用 [MIT License](LICENSE)。**该许可不授予《罗小黑战记》的角色、名称、故事、美术设计、商标或其他原作内容的权利，也不覆盖本仓库的同人贴图、截图和视频。** 各素材的来源和状态见 [ASSET_CREDITS.md](ASSET_CREDITS.md)。

公开仓库不代表官方授权。“同人”“非商用”标签也不代替权利人的许可。希望用于其他项目时，请分别核对代码与美术的权利范围。我们尚未核实到适用于本项目的官方统一再分发许可。
